...
const OPERATOR = Object.freeze({
  ...
  RIPPLETRACE_STATUS: `${PLAT}/observability/rippletrace/status`,
...
// ══ LEGACY ════════════════════════════════════════════════════════════════════
// Lives in the monolith (aindy-apps), not served by aindy-runtime.
// These constants are commented out. Any NavLink or API call referencing them
// must be conditioned on the monolith host or removed before re-enabling.
// ══════════════════════════════════════════════════════════════════════════════
...
// PLATFORM unserved subset (not in runtime OpenAPI; likely monolith or future):
